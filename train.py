...
class SCEIR_Model(nn.Module):
    ...
    def forward(self, batch):
        ...
        # Inspired by the Gray World, we provide a gray-raio version to improve its generalization ability
        # gray-ratio   ratio =  mean channel / mean red channel
...
if __name__ == "__main__":
    ...
    # dataset path
    parser.add_argument('--patch_low', type=str,
                        default="./dataset/UIEBD/train/raw")
    parser.add_argument('--patch_high', type=str,
                        default="./dataset/UIEBD/train/ref")

    parser.add_argument('--eval_low', type=str,
                        default="./dataset/UIEBD/eval/raw")
    parser.add_argument('--eval_high', type=str,
